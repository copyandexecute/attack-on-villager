...
public class VillagerBowAttackGoal<T extends VillagerEntity> extends Goal {
    ...
    public VillagerBowAttackGoal(T actor, double speed, int attackInterval, float range) {
        this.actor = actor;
        this.speed = speed;
    ...
    public void tick() {
        ...
        if (!bl && this.targetSeeingTicker < -60) {
            ...
            this.actor.clearActiveItem();
            ((AttackedVillager) this.actor).shoot(livingEntity, BowItem.getPullProgress(60));
            this.cooldown = 0;
        }
        ++cooldown;
    }
